...
def pick_yoru():
    agents.selected_agent = agents.agents["Yoru"]
    print("Picked: Yoru")
...
gomb_clove.grid(row=0, column=4, padx=10, pady=10)
...
gomb_cypher.grid(row=0, column=5, padx=10, pady=10)
...
gomb_deadlock.grid(row=0, column=6, padx=10, pady=10)
...
gomb_fade.grid(row=0, column=7, padx=10, pady=10)
...
gomb_gekko.grid(row=0, column=8, padx=10, pady=10)
...
gomb_harbor.grid(row=1, column=0, padx=10, pady=10)
...
gomb_iso.grid(row=1, column=1, padx=10, pady=10)
...
gomb_jett.grid(row=1, column=2, padx=10, pady=10)
...
gomb_kayo.grid(row=1, column=3, padx=10, pady=10)
...
gomb_killjoy.grid(row=1, column=4, padx=10, pady=10)
...
gomb_neon.grid(row=1, column=5, padx=10, pady=10)
...
gomb_omen.grid(row=1, column=6, padx=10, pady=10)
...
gomb_phoenix.grid(row=1, column=7, padx=10, pady=10)
...
gomb_raze.grid(row=1, column=8, padx=10, pady=10)
...
gomb_reyna.grid(row=2, column=0, padx=10, pady=10)
...
gomb_sage.grid(row=2, column=1, padx=10, pady=10)
...
gomb_skye.grid(row=2, column=2, padx=10, pady=10)
...
gomb_sova.grid(row=2, column=3, padx=10, pady=10)
...
gomb_viper.grid(row=2, column=4, padx=10, pady=10)

gomb_yoru = Button(window, text='Yoru')
gomb_yoru.config(command=pick_yoru)
kep_yoru = PhotoImage(file="Yoru.png")
gomb_yoru.config(image=kep_yoru)
gomb_yoru.grid(row=2, column=5, padx=10, pady=10)
